...
execute if score $date_year eden.technical matches 1.. if score $date_is_valid eden.technical matches 1 run function huds:set_date/apply
execute unless score $date_year eden.technical matches 1.. run function huds:set_date/invalid
execute if score $date_year eden.technical matches 1.. unless score $date_is_valid eden.technical matches 1 run function huds:set_date/invalid
